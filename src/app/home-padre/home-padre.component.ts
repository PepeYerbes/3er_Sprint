// filepath: c:\Users\jose.yerbes\Documents\3°Sprint\pruebas_sprint_3\src\app\home-padre\home-padre.component.ts
...
@Component({
  ...
  imports: [HomeModule, HomeComponent]
})
export class HomePadreComponent {
  displayMode: 'list' | 'grid' = 'list';

  changeDisplayMode(mode: 'list' | 'grid') {
